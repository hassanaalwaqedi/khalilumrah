            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="prose max-w-none text-right mb-12">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed mb-6">
                        نحرص في خليل الواقدي للحج والعمرة على تقديم برامج حج متكاملة تشمل كافة الخدمات التي يحتاجها الحاج، بدءاً من التسجيل واستخراج التصاريح، مروراً بالتنقل والسكن في المشاعر المقدسة، وحتى العودة إلى أرض الوطن سالماً غانماً.
                    </p>
                </div>
